...
func TestGetPageMissingIDReturnsError(t *testing.T) {
	t.Parallel()
	...
	if atlasError.Code != atlaserr.CodeInvalidArgument {
		t.Fatalf("expected code %s, got %s", atlaserr.CodeInvalidArgument, atlasError.Code)
	}
}
